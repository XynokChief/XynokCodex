...
namespace XynokConvention.Procedural
{
    public class EventManager
    {
        ...
        private static Dictionary<string, object> sender = new();
        private static Dictionary<string, bool> paused = new();
        ...
        private static Dictionary<string, object[]> storage2 = new();

        // The memory storage used by the IndexedDataGroup methods.
        private static Dictionary<string, DataGroup[]> storage3 = new();

        // Manage unique IDs associated to a callBack function, so as to use IDs as reference instead of callBacks.
        private static Dictionary<string, UnityAction> callBacks = new();
        ...
        public static object GetData(string eventName)
        {
            ...
            {
                Debug.LogError($"data of {eventName} is not valid !");
                return null;
            }
        }
